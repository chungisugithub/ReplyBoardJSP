...
<head>
    ...
    <style type="text/css">
    .myButton {
    width:173px;line-height: 40px;border: 1px solid #f7941e; color:#fff; background:#f7941e;
    }
    </style>
</head>
<body>
    ...
    <section id="container" class="sub">
        ...
        <form>
            ...
            <div class="write_date">
                <span class="write_line"><strong>작성자  :</strong> <%=article.getWriter()%> </span>
                <span class="write_line"><strong>조회수  :</strong> <%=article.getReadcount()%> </span>
                <span class="write_line"><%= sdf.format(article.getReg_date())%></span>
            ...
            <div class="con_box">
                    ...
                    <colgroup>
                        ...
                        <td style="text-align:left; vertical-align: top; height:200px;padding-top:20px">
